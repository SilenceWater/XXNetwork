...
@implementation XXNetworkServiceObject
...
/**
 默认XXRequestSerializerTypeHTTP
 
 @return [AFHTTPRequestSerializer serializer]
 */
- (XXRequestSerializerType)serviceRequestSerializerType {
    return XXRequestSerializerTypeHTTP;
}
...
/**
 默认XXResponseSerializerTypeJSON
 
 @return [AFJSONResponseSerializer serializer]
 */
- (XXResponseSerializerType)serviceResponseSerializerType {
    return XXResponseSerializerTypeJSON;
}
...
- (XXServiceAuthenticationStatus)serviceBaseAuthenticationWithNetworkRequest:(XXNetworkRequest *)networkRequest response:(id)response {
    ...
    if (response) {
        return XXServiceAuthenticationStatusPass;
    }
    
    return XXServiceAuthenticationStatusWrong;
}
